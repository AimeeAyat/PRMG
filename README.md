# 1. Train all 6 reward models
python at_prmd_implementation/2_train_reward_models.py harmless 0
python at_prmd_implementation/2_train_reward_models.py harmless 1
python at_prmd_implementation/2_train_reward_models.py helpful 0
python at_prmd_implementation/2_train_reward_models.py helpful 1
python at_prmd_implementation/2_train_reward_models.py honest 0
python at_prmd_implementation/2_train_reward_models.py honest 1
python at_prmd_implementation\2_train_reward_models.py quality 0
python at_prmd_implementation\2_train_reward_models.py quality 1

# 2. Visualize reward model training
python at_prmd_implementation/visualize_reward_training.py

# 3. Train AT-PRMD policy
python at_prmd_implementation/3_train_policy.py

# 4. Visualize policy training
python at_prmd_implementation/visualize_policy_training.py

# 5. Evaluate on benchmarks
python at_prmd_implementation/4_evaluate_benchmarks.py

# 6. Visualize evaluation results
python at_prmd_implementation/5_visualize_results.py
